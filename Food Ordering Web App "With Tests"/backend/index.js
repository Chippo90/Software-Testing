...
let menu = [
  { id: 'm1', name: 'Margherita Pizza', description: 'Tomato, mozzarella', category: 'Pizza', price: 8.5},
  { id: 'm2', name: 'Pepperoni Pizza', description: 'Pepperoni, cheese', category: 'Pizza', price: 9.5},
  { id: 'm3', name: 'Caesar Salad', description: 'Lettuce, dressing', category: 'Salad', price: 6.0},
  { id: 'm4', name: 'Spaghetti Bolognese', description: 'Meat sauce', category: 'Pasta', price: 10.0},
  { id: 'm5', name: 'Tiramisu', description: 'Coffee dessert', category: 'Dessert', price: 4.5}
];
...
app.post('/api/orders', (req, res) => {
  ...
  const id = uuidv4();
  const order = { id, name, contact, items, subtotal, total, status: 'received', createdAt: new Date().toISOString() };
  orders[id] = order;
