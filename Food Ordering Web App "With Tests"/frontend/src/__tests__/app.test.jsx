...
const mockMenu = [
    { id: 'm1', name: 'Pizza', description: 'Cheese', category: 'Pizza', price: 8 },
    { id: 'm2', name: 'Salad', description: 'Fresh', category: 'Salad', price: 6 },
];

beforeEach(() => {
    axios.get.mockImplementation(url => {
        if (url.endsWith('/api/menu')) return Promise.resolve({ data: mockMenu });
        if (url.endsWith('/api/categories')) return Promise.resolve({ data: ['Pizza', 'Salad'] });
    });
});
